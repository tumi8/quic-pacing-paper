...
impl<'a> ControlMessage<'a> {
    ...
    fn copy_to_cmsg_data(&self, cmsg_data: *mut u8) {
        let data_ptr = match *self {
            ...
            #[cfg(target_os = "linux")]
            #[cfg(feature = "net")]
            ControlMessage::UdpGsoSegmentPacingRate(rate) => {
                rate as *const _ as *const u8
            },
    ...
    fn cmsg_level(&self) -> libc::c_int {
        match *self {
            ...
            #[cfg(target_os = "linux")]
            #[cfg(feature = "net")]
            ControlMessage::UdpGsoSegmentPacingRate(_) => libc::SOL_UDP,
            #[cfg(any(target_os = "linux", target_os = "macos",
                      target_os = "netbsd", target_os = "android",
                      target_os = "ios",))]
            #[cfg(feature = "net")]
    ...
    fn cmsg_type(&self) -> libc::c_int {
        match *self {
            ...
            #[cfg(target_os = "linux")]
            #[cfg(feature = "net")]
            ControlMessage::UdpGsoSegmentPacingRate(_) => {
                105
            },
            #[cfg(any(target_os = "linux", target_os = "macos",
                      target_os = "netbsd", target_os = "android",
